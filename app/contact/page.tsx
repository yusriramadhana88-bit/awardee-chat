  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-4 py-12 lg:px-8">
        ...
        <h1 className="text-3xl font-bold text-ink mt-6 mb-2">Kontak Kami</h1>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          >
            ...
            <h2 className="font-semibold text-ink group-hover:text-green-700">WhatsApp DenDhana</h2>
            <p className="text-sm text-muted mt-1">Untuk mentoring privat, konfirmasi pembayaran, dan pertanyaan umum. Jam respons: 07.00–22.00 WIB.</p>
          ...
          >
            ...
            <h2 className="font-semibold text-ink group-hover:text-navy">Email</h2>
            <p className="text-sm text-muted mt-1">Untuk laporan teknis, DMCA, kemitraan, atau pertanyaan formal. Respons dalam 1–2 hari kerja.</p>
          ...
          >
            <div className="text-3xl mb-2">📸</div>
            <h2 className="font-semibold text-ink group-hover:text-pink-700">Instagram</h2>
            <p className="text-sm text-muted mt-1">Update terbaru, tips beasiswa, dan inspirasi dari komunitas awardee.</p>
            <span className="text-xs text-pink-600 font-medium mt-2 block">@awardee.id →</span>
          </a>

          <div className="bg-purple-50 border border-purple-200 rounded-xl p-5">
            <div className="text-3xl mb-2">🎓</div>
            <h2 className="font-semibold text-ink">Mentoring Privat</h2>
        ...
        <div className="mt-8 bg-off border border-hairline rounded-xl p-5">
          <h3 className="font-semibold text-ink text-sm mb-2">Jam Operasional</h3>
          ...
          <p className="text-xs text-muted mt-3">Platform AI tersedia 24/7. Respons tim manusia sesuai jam operasional.</p>
        </div>
      </div>
    </div>
  )
