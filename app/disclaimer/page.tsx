  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-4 py-12 lg:px-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mt-6 mb-2">Disclaimer</h1>
        ...
        <div className="prose prose-gray max-w-none space-y-6 text-gray-700 leading-relaxed">
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">Tidak Ada Jaminan Kelulusan</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">Ketepatan Informasi AI</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">Tanggung Jawab Pengguna</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">Sumber Data</h2>
            <p>
