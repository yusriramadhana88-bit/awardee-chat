  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-4 py-12 lg:px-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mt-6 mb-2">Kebijakan Privasi</h1>
        <p className="text-sm text-gray-400 mb-8">Terakhir diperbarui: Juni 2026</p>

        <div className="prose prose-gray max-w-none space-y-6 text-gray-700 leading-relaxed">
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">Data yang Kami Kumpulkan</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">Bagaimana Kami Menggunakan Data</h2>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">Berbagi Data</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">Penyimpanan & Keamanan</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">Hak Anda</h2>
            <p>Anda berhak untuk mengakses, mengkoreksi, atau menghapus data pribadi Anda. Hubungi kami melalui <Link href="/contact" className="text-sky-600 hover:underline">halaman kontak</Link> untuk permintaan tersebut.</p>
          </section>
        </div>
      </div>
    </div>
